...
This project uses the Telco Customer Churn dataset.The dataset contains customer information including:
    * Demographic details
    * Account information
    * Service usage
    * Billing information
...
Steps performed:
   * Loaded dataset
   * Reviewed data typesExamined dataset shape
...
Building a dashboard for churn monitoring# Churn-Prediction-And-Recommendation-
